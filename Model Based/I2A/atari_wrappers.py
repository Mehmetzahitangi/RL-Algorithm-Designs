...
class FireResetEnv(gym.Wrapper):
    ...
    def reset(self, **kwargs):
        # Gymnasium reset() iki değer döner: obs, info
...
class BufferWrapper(gym.ObservationWrapper):
    ...
    def observation(self, observation):
        ...
        # KRİTİK DÜZELTME: (1, 84, 84) boyutunu havuza sıkıştırarak ekliyoruz
        self.buffer[-1] = np.squeeze(observation, axis=0) 
        return self.buffer
...
def make_env(env_name, render_mode=None):
    ...
    print(f"Ortam Yükleniyor: {env_name}")
