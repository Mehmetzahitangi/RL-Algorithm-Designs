...
class FireResetEnv(gym.Wrapper):
    def __init__(self, env=None):
        """Oyunun başlaması için kullanıcının ATEŞ ETME tuşuna basması gereken ortamlar için."""
...
class MaxAndSkipEnv(gym.Wrapper):
    def __init__(self, env=None, skip=4):
        """Yalnızca her `skip`-karede bir kare döndür."""
    ...
    def reset(self, **kwargs):
        """Geçmiş frame buffer'ı temizle ve başlat."""
...
def make_env(env_name, render_mode=None):
    ...
    print(f"Yüklenen Atari Ortamı: {env_name}")
    
    # KRİTİK: frameskip=1 parametresi, eski "NoFrameskip" in karşılığıdır
    # Kendi MaxAndSkipEnv sınıfımız 4 kare atlayacağı için, ortamın kendisi kare atlamamalı
